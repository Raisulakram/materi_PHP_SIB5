...
<table border="1" cellpadding="10" cellspacing="0" width="100%">
    ...
    <tfoot bgcolor="yellow">
        <tr>
            ...
            <td align="center" colspan="5"><?= $nilai_tertinggi ?></td>

        </tr>
        <tr>
            <th colspan="3">Nilai terendah</th>
            <td align="center" colspan="5"><?= $nilai_terendah ?></td>
            
        </tr>
        <tr>
            <th colspan="3">Nila rata-rata</th>
            <td align="center" colspan="5"><?= number_format($rata_rata_nilai, 2) ?></td>
        </tr>
        <tr>
            <th colspan="3">Jumlah Mahasiswa</th>
            <td align="center" colspan="5"><?= $jumlah_mahasiswa ?></td>
        </tr>
        <tr>
            <th colspan="3">Jumlah Nilai Keseluruhan</th>
            <td align="center" colspan="5"><?= $jumlah_nilai_keseluruhan ?></td>
        </tr>
    </tfoot>
</table>
